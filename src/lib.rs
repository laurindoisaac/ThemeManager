...
#[derive(Debug)]
pub struct ThemeManagerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ThemeManagerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ThemeManager processing");
    
    let mut processor = ThemeManagerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ThemeManagerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ThemeManagerProcessor::new(false);
